...
public class FilmManagerTest {
    ...
    public void testSearchByTitle() {
        Film film = new Film("Pulp Fiction", "Crime", 1994, 8.9);
        filmManager.addFilm(film);
    ...
    public void testSearchByGenre() {
        Film film1 = new Film("The Shawshank Redemption", "Drama", 1994, 9.3);
        Film film2 = new Film("Forrest Gump", "Drama", 1994, 8.8);
